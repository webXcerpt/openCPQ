...
function CValidate(testFn, type = CUnit()) {
	return new Type("validate", function makeValidate(value, updateTo, ctx) {
		return new ValidationNode(testFn, type.makeNode(value, updateTo, ctx), ctx);
	});
}
...
function CValidationMessages(messages) {
	return new Type("validationMessages", function makeValidationMessages(value, updateTo, ctx) {
